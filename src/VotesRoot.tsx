...
const VotesSummary = lazy(() => import("./Views/VotesSummary/index.tsx"));
const VotesMap = lazy(() => import("./Views/VotesMap/index.tsx"));
const VotesScatterPlot = lazy(() => import("./Views/VotesScatter/index.tsx"));
const VotesTable = lazy(() => import("./Views/VotesTable/index.tsx"));
