...
export default function VoteMapOptions({ updateElevationApproach, updateShowOptions, elevationApproach, updateColorApproach, colorApproach, elections, absenteeBase, updateAbsenteeBase, electionResultBase, updateElectionResultBase, electionResultCurrent, updateElectionResultCurrent, showVoteMode,
    updateShowVoteMode, showDemographics, updateShowDemographics, showAbsentee, updateShowAbsentee }) {
    ...
    return <React.Fragment><h1>Options
        ...
        <div><b>Summary Data Displayed:</b></div>
        <Checkbox onChange={(e) => { updateShowAbsentee(e.target.checked) }} checked={showAbsentee}>Absentee Ballots</Checkbox><br />
        <Checkbox onChange={(e) => { updateShowVoteMode(e.target.checked) }} checked={showVoteMode}>Votes by Mode</Checkbox><br />
        <Checkbox onChange={(e) => { updateShowDemographics(e.target.checked) }} checked={showDemographics}>Demographics</Checkbox><br />
        <br />
